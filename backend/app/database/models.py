...
class Student(Base):
    ...
    def email(self) -> str | None:
        return f"{self.student_code.lower()}@autoroll.edu"
...
class StudentEmbedding(Base):
    ...
    template_vector = Column(LargeBinary, nullable=True)   # Serialized 512 float32 bytes alias
    model_id = Column(String(50), nullable=True, default="autoroll_v1")
    model_version = Column(String(50), nullable=False, default="autoroll_arcface_r50_epoch1")
    embedding_dimension = Column(Integer, nullable=True, default=512)
    sample_count = Column(Integer, nullable=True, default=1)
...
# Alias FaceTemplate to StudentEmbedding
FaceTemplate = StudentEmbedding
